...
PROMPT = (
    ...
    'utility bills, subscriptions, service invoices = "Expense"; small cash receipts (shop/petrol/food, typically under RM200 cash) = "Petty Cash"; '
    ...
    f'"category": best guess from {CATEGORIES} or ""\n'
)
